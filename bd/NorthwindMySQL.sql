...
--
-- Definition of table `CustomerCustomerDemo`
--
...
--
-- Dumping data for table `CustomerCustomerDemo`
--

--
-- Definition of table `CustomerDemographics`
--
...
--
-- Definition of table `EmployeeTerritories`
--
